...
export const displayCourse = (course: { courseCode: string, courseDescription: string }) => {
  return {
    type: 'DISPLAY_COURSE',
...
export const changeSelectedCourse = (course: { courseCode: string, courseDescription: string, prereqs: Array<string>, coreqs: Array<string>, future: Array<string>}) => {
    return {
        ...
        courseCode: course.courseCode, // SPLIT THE COURSECODE: LETTERS + NUMBERS; session number possible as well
